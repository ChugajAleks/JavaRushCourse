...
средний вес. Кот не может ничего не весить. То же касательно возраста. А вот имени может и не быть (null). То же касается
адреса: null.
*/
...
public class Cat
{
    ...
    public void initialize(String name, int weight, int ege)
    {

    }
    public void initialize(String name, int ege)
    {
